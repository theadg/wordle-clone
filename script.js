...
enter.onclick = () => {
    ...
    console.log(`WHY IS MY WORD MISSING? ${word}`);
};
...
checkFirstLetter = () => {
    ...
    if (answer.includes(first) && answer.indexOf(first) === 0){
        ...
        setTimeout(function(){
            buttons[0].classList.add('correct-g');
        }, 1000);
        ...
        setTimeout(function(){
            buttons[0].classList.add('almost-correct-g');;
        }, 1000);
        ...
        setTimeout(function(){
            buttons[0].classList.add('wrong-g');;
        }, 1000);
    }
};
...
checkSecondLetter = () => {
    ...
    if (answer.includes(first) && answer.indexOf(first) === 1){
        setTimeout(function() {  //add animation delay
           ...
           setTimeout(function(){
            buttons[1].classList.add('correct-g');
        }, 1000);
        ...
        setTimeout(function() {  //add animation delay
           ...
           setTimeout(function(){
            buttons[1].classList.add('almost-correct-g');
        }, 1000);
    } else {
        setTimeout(function() {  //add animation delay
        ...
        setTimeout(function(){
            buttons[1].classList.add('wrong-g');
        }, 1000);
...
checkThirdLetter = () => {
    ...
    if (answer.includes(first) && answer.indexOf(first) === 2){
        setTimeout(function() {  //add animation delay
           ...
           setTimeout(function(){
            buttons[2].classList.add('correct-g');
        }, 1000);
        ...
        setTimeout(function() {  //add animation delay
           ...
           setTimeout(function(){
            buttons[2].classList.add('almost-correct-g');
        }, 1000);
    } else {
        setTimeout(function() {  //add animation delay
           ...
           setTimeout(function(){
            buttons[2].classList.add('wrong-g');
        }, 1000);
    }
};
...
checkFourthLetter = () => {
    ...
    if (answer.includes(first) && answer.indexOf(first) === 3){
        setTimeout(function() {  //add animation delay
           ...
           setTimeout(function(){
            buttons[3].classList.add('correct-g');
        }, 1000);
        ...
        setTimeout(function() {  //add animation delay
           ...
           setTimeout(function(){
            buttons[3].classList.add('almost-correct-g');
        }, 1000);
    } else {
        setTimeout(function() {  //add animation delay
           ...
           setTimeout(function(){
            buttons[3].classList.add('wrong-g');
        }, 1000);
    }
};
...
checkFifthLetter = () => {
    ...
    if (answer.includes(first) && answer.indexOf(first) === 4){
        setTimeout(function() {  //add animation delay
           ...
           setTimeout(function(){
            buttons[4].classList.add('correct-g');
        }, 1000);
        ...
        setTimeout(function() {  //add animation delay
           ...
           setTimeout(function(){
            buttons[4].classList.add('almost-correct-g');
        }, 1000);
    } else {
        setTimeout(function() {  //add animation delay
           ...
           setTimeout(function(){
            buttons[4].classList.add('wrong-g');
        }, 1000);
    }
};
